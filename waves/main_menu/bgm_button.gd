...
const _audioOff = preload("res://assets/kenney/ui-pack/musicOff.png")
const _audioOn = preload("res://assets/kenney/ui-pack/musicOn.png")
...
func _ready() -> void:
	set_bus('BGM', _audioOff, _audioOn)
